...
export const ui = {
  'en': {
    ...
    'siteMetadata.description': 'A frontend web developer. Specialized in React, Symfony, and more. Elevate your digital experiences with unique themes, SEO optimization, responsive design, and interactive motions!',
    'siteMetadata.jobTitle': 'Senior Frontend Web Developer',
    'siteMetadata.language': 'en-US',

    // Pages
    'pages.home.latestPosts': 'Latest posts',
    'pages.home.viewAllPosts': 'View all',
    ...
    'pages.tags.metaTitle': 'Explore Topics - CSS, Git, JavaScript & More',
    ...
    'pages.projects.metaTitle': 'Saida Lachgar - Frontend Web Developer Project Showcase',
    'pages.projects.metaDescription': 'Showcase of innovative projects developed by a highly skilled developer. Explore diverse industries, technologies, and challenges overcome in the fields of eCommerce, Tourism, Healthcare, and more.',
