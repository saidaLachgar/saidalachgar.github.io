...
export const ui = {
  'en': {
    ...
    'siteMetadata.description': 'Frontend developer skilled in React & Symfony. Crafting SEO-optimized, responsive, and interactive digital experiences',
    ...
    'pages.tags.description': 'Discover all blog tags to easily navigate through topics like Git, CSS, SEO, and more development insights',
    ...
    'pages.projects.metaDescription': 'Explore Saida\'s portfolio, featuring projects in eCommerce, tourism, healthcare, and more. Innovative solutions across industries!',
